...
function (_Component) {
  ...
  function Dropdown() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleBlur", function (e) {
      ...
      if (currentTarget && (currentTarget.contains(document.activeElement) || currentTarget.contains(e.relatedTarget))) return;
    ...
    _defineProperty(_assertThisInitialized(_this), "getDropdownAriaOptions", function () {
      ...
      var ariaOptions = {
        ...
        'aria-labelledby': !search ? _this.props['aria-labelledby'] : null,
        'aria-describedby': !search ? _this.props['aria-describedby'] : null,
        'aria-invalid': !search ? _this.props['aria-invalid'] : null // aria-labelledby only set when no search input is provided, when search is set, getSearchInputAriaOptions is used instead

      };

      if (!search) {
        if (ariaOptions['aria-labelledby'] && id) {
          ariaOptions['aria-labelledby'] = "".concat(ariaOptions['aria-labelledby'], " ").concat(id, "-rendered-text");
        } else if (id) {
          ariaOptions['aria-labelledby'] = "".concat(id, "-rendered-text");
        }
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "open", function (e) {
      ...
      _this.scrollSelectedItemIntoView(); // TODO improve this


      if (!search && _this.ref.current && _this.ref.current.querySelector('.menu')) {
        setTimeout(function () {
          _this.ref.current.querySelector('.menu').focus();
        }, 10);
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderText", function () {
      ...
      var _id = id ? "".concat(id, "-rendered-text") : null;
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSearchInput", function () {
      ...
      var ariaOptions = _this.getSearchInputAriaOptions();
    ...
    _defineProperty(_assertThisInitialized(_this), "renderLabels", function () {
      ...
      return _map(_compact(selectedItems), function (item, index) {
        var defaultProps = {
          ...
          value: item.value,
          id: id ? "".concat(id, "-value-").concat(index) : null,
          role: 'alert',
          'aria-live': 'assertive'
        };
    ...
    _defineProperty(_assertThisInitialized(_this), "renderOptions", function () {
      ...
      return _map(options, function (opt, i) {
        return DropdownItem.create(_objectSpread({
          ...
          id: id ? "".concat(id, "-option-").concat(i) : null
        }, opt, {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMenu", function () {
      ...
      var activeItem = id ? "".concat(id, "-option-").concat(selectedIndex) : null;
      var activeDescendant = open && !search ? activeItem : null;
  ...
  _createClass(Dropdown, [{
    ...
    key: "getSearchInputAriaOptions",
    value: function getSearchInputAriaOptions() {
      ...
      var activeDescendant = open && id ? "".concat(id, "-option-").concat(selectedIndex) : null;
      var ariaLabelledBy = this.props['aria-labelledby'];

      if (ariaLabelledBy && id) {
        ariaLabelledBy = "".concat(ariaLabelledBy, " ").concat(id, "-rendered-text");
      } else if (id) {
        ariaLabelledBy = "".concat(id, "-rendered-text");
      }

      if (multiple && id && value) {
        var options = value.map(function (key, index) {
          return "".concat(id, "-value-").concat(index);
        }).join(' ');

        if (ariaLabelledBy) {
          ariaLabelledBy = "".concat(ariaLabelledBy, " ").concat(options);
        } else {
    ...
    value: function render() {
      var _this$props21 = this.props,
          basic = _this$props21.basic,
          button = _this$props21.button,
          className = _this$props21.className,
          compact = _this$props21.compact,
          disabled = _this$props21.disabled,
          error = _this$props21.error,
          fluid = _this$props21.fluid,
          floating = _this$props21.floating,
          icon = _this$props21.icon,
          id = _this$props21.id,
          inline = _this$props21.inline,
          item = _this$props21.item,
          labeled = _this$props21.labeled,
          loading = _this$props21.loading,
          multiple = _this$props21.multiple,
          pointing = _this$props21.pointing,
          search = _this$props21.search,
          selection = _this$props21.selection,
          scrolling = _this$props21.scrolling,
          simple = _this$props21.simple,
          trigger = _this$props21.trigger;
      var _this$state10 = this.state,
          focus = _this$state10.focus,
          open = _this$state10.open,
          upward = _this$state10.upward; // Classes

      var classes = cx('ui', useKeyOnly(open, 'active visible'), useKeyOnly(focus, 'focus'), useKeyOnly(disabled, 'disabled'), useKeyOnly(error, 'error'), useKeyOnly(loading, 'loading'), useKeyOnly(basic, 'basic'), useKeyOnly(button, 'button'), useKeyOnly(compact, 'compact'), useKeyOnly(fluid, 'fluid'), useKeyOnly(floating, 'floating'), useKeyOnly(inline, 'inline'), // TODO: consider augmentation to render Dropdowns as Button/Menu, solves icon/link item issues
...
_defineProperty(Dropdown, "handledProps", ["additionLabel", "additionPosition", "allowAdditions", "aria-describedby", "aria-invalid", "aria-labelledby", "as", "basic", "button", "children", "className", "clearable", "closeOnBlur", "closeOnChange", "closeOnEscape", "compact", "deburr", "defaultOpen", "defaultSearchQuery", "defaultSelectedLabel", "defaultUpward", "defaultValue", "direction", "disabled", "error", "floating", "fluid", "header", "icon", "id", "inline", "item", "labeled", "lazyLoad", "loading", "minCharacters", "multiple", "noResultsMessage", "onAddItem", "onBlur", "onChange", "onClick", "onClose", "onFocus", "onLabelClick", "onMouseDown", "onOpen", "onSearchChange", "open", "openOnFocus", "options", "placeholder", "pointing", "renderLabel", "scrolling", "search", "searchInput", "searchQuery", "selectOnBlur", "selectOnNavigation", "selectedLabel", "selection", "simple", "tabIndex", "text", "trigger", "upward", "value", "wrapSelection"]);
