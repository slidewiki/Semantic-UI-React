...
function (_Component) {
  ...
  function Dropdown() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Dropdown)).call.apply(_getPrototypeOf2, [this].concat(args))), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (e, value) {
    ...
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getAriaActiveDescendant", function () {
      var id = _this.props.id;
      var _this$state3 = _this.state,
          selectedIndex = _this$state3.selectedIndex,
          value = _this$state3.value;
      return id && value && (selectedIndex || selectedIndex === 0) ? "".concat(id, "-option-").concat(selectedIndex) : undefined;
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getAriaLabelledBy", function () {
      var _this$props8 = _this.props,
          id = _this$props8.id,
          multiple = _this$props8.multiple;
      var value = _this.state.value;
      var labelledBy = _this.props['aria-labelledby'];

      if (multiple && value) {
        var multipleSelected = value.map(function (val) {
          return _this.getItemId(val);
        }).join(' ');
        labelledBy = labelledBy ? "".concat(labelledBy, " ").concat(multipleSelected) : multipleSelected;
      }

      return id ? "".concat(labelledBy, " ").concat(id, "-selected") : labelledBy;
    ...
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getItemId", function (value) {
      var id = _this.props.id;
      return "".concat(id, "-selected-tag-").concat(value.replace(/\s/g, ''));
      ...
      var ariaOptions = {
        ...
        'aria-expanded': !!open,
        'aria-labelledby': !search ? _this.getAriaLabelledBy() : undefined,
        'aria-haspopup': 'listbox'
      };
      if (multiple) ariaOptions['aria-multiselectable'] = multiple;
      if (!search) ariaOptions['aria-activedescendant'] = _this.getAriaActiveDescendant();
      return ariaOptions;
      ...
      var _this$props11 = _this.props,
          ...
          tabIndex = _this$props11.tabIndex; // don't set a root node tabIndex as the search input has its own tabIndex
      ...
      if (id) {
        extraProps.id = "".concat(id, "-selected");
      }
      ...
      return DropdownSearchInput.create(searchInput, {
        defaultProps: {
          ariaActiveDescendant: _this.getAriaActiveDescendant(),
          ariaLabelledBy: _this.getAriaLabelledBy(),
      ...
      return _map(_compact(selectedItems), function (item, index) {
        var defaultProps = {
          ...
          value: item.value,
          id: id ? _this.getItemId(item.value) : undefined
        };
      ...
      var _this$props17 = _this.props,
          lazyLoad = _this$props17.lazyLoad,
      ...
      return _map(options, function (opt, i) {
        return DropdownItem.create(_objectSpread({
          ...
          id: id ? "".concat(id, "-option-").concat(i) : undefined
        }));
      });
      ...
      var _this$props18 = _this.props,
          ...
          direction = _this$props18.direction,
  ...
  _createClass(Dropdown, [{
      ...
      if (!prevState.focus && this.state.focus) {
        if (!this.isMouseDown) {
          var _this$props19 = this.props,
              minCharacters = _this$props19.minCharacters,
              openOnFocus = _this$props19.openOnFocus,
    ...
    value: function render() {
      ...
      var _this$state8 = this.state,
          ...
          upward = _this$state8.upward,
          focus = _this$state8.focus; // Classes

      var classes = cx('ui', useKeyOnly(focus, 'focus'), useKeyOnly(open, 'active visible'), useKeyOnly(disabled, 'disabled'), useKeyOnly(error, 'error'), useKeyOnly(loading, 'loading'), useKeyOnly(basic, 'basic'), useKeyOnly(button, 'button'), useKeyOnly(compact, 'compact'), useKeyOnly(fluid, 'fluid'), useKeyOnly(floating, 'floating'), useKeyOnly(inline, 'inline'), // TODO: consider augmentation to render Dropdowns as Button/Menu, solves icon/link item issues
...
_defineProperty(Dropdown, "handledProps", ["additionLabel", "additionPosition", "allowAdditions", "aria-labelledby", "as", "basic", "button", "children", "className", "closeOnBlur", "closeOnChange", "compact", "deburr", "defaultOpen", "defaultSearchQuery", "defaultSelectedLabel", "defaultUpward", "defaultValue", "direction", "disabled", "error", "floating", "fluid", "header", "icon", "id", "inline", "item", "labeled", "lazyLoad", "loading", "minCharacters", "multiple", "noResultsMessage", "onAddItem", "onBlur", "onChange", "onClick", "onClose", "onFocus", "onLabelClick", "onMouseDown", "onOpen", "onSearchChange", "open", "openOnFocus", "options", "placeholder", "pointing", "renderLabel", "scrolling", "search", "searchInput", "searchQuery", "selectOnBlur", "selectOnNavigation", "selectedLabel", "selection", "simple", "tabIndex", "text", "trigger", "upward", "value", "wrapSelection"]);
